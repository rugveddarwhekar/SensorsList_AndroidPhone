...
public class Gravity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mySensorManager.registerListener(Gravity.this, gravity, mySensorManager.SENSOR_DELAY_NORMAL);
    }
    ...
    protected void onResume() {
        super.onResume();
        mySensorManager.registerListener(this, gravity, SensorManager.SENSOR_DELAY_NORMAL);
    }
