...
public class Magnet extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        magnet = mySensorManager.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD);
        mySensorManager.registerListener(Magnet.this, magnet, mySensorManager.SENSOR_DELAY_NORMAL);
    ...
    protected void onResume() {
        super.onResume();
        mySensorManager.registerListener(this, magnet, SensorManager.SENSOR_DELAY_NORMAL);
    }
